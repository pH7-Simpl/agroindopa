...
<head>
    ...
    <style>
        .footer {
            ...
            bottom: 0;
            width: 100%;
            /* Stretches across entire width */
            height: auto;
            /* Allows footer to adjust height based on content */
        }
    </style>
</head>
...
<body class="font-sans">
    <header class="bg-[#2E3D2A] text-white p-1 rounded-b-3xl">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="flex gap-2 items-center justify-end cursor-pointer" onclick="toggleDropdown()">
                ...
                <div id="dropdown"
                    class="hidden absolute top-20 bg-[#F8FAE5] border border-neutral-300 rounded-md shadow-lg z-10 text-black">
                    <a href="/profil" class="flex justify-start items-center py-3 pl-4 pr-6 gap-4 hover:bg-[#d8dac7]">
                        <p>Profil</p>
                    </a>
                    <a href="/dashboard"
    ...
    <footer class="footer bg-[#2E3D2A] text-white py-6 mt-4 rounded-t-3xl">
        <div class="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-4 text-wrap items-center">
                    ...
                    <p class="whitespace-normal">Denmoza Hill 1, Ulesari, Tirtomoyo, Pakis Subdistrict, Malang Regency,
                        East Java, Indonesia 65154</p>
                </div>
                <div class="flex gap-4 text-wrap items-center">
            ...
            <div class="flex items-center justify-center space-x-12">
                <div>
                    <a href="https://t.me/6282337458131?text=Hi,20%i20%want20%to20%buy." class="fa fa-telegram"
                        style="font-size:56px"></a>
                </div>
                <div>
                    <a href="https://wa.me/6282337458131?text=Hi,20%i20%want20%to20%buy." class="fa fa-whatsapp"
                        style="font-size:56px"></a>
                </div>
                <div>
