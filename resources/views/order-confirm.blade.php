    ...
    <div class="mx-8 py-12">
      <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="bg-[#2E3D2A] shadow-md rounded-md p-6 text-white">
              ...
              <p class="">12345</p>
              <button class="absolute mt-4 px-6 py-2 bg-white text-black font-semibold rounded-lg ">Change Address</button>
          ...
          <div class="bg-[#2E3D2A] shadow-md rounded-md p-6  text-white">
              ...
              <div class="flex items-center justify-center">
                <button class="mt-4 px-6 py-2 bg-white text-black font-semibold rounded-lg  ">Select Payment</button>
              </div>
          </div>
