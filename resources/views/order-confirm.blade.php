    ...
    <div class="mx-8 py-12">
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-[#2E3D2A] shadow-md rounded-md p-6 text-white">
                ...
                <div class="flex items-center justify-center">
                    <a href="https://wa.me/6282337458131?text=Hi, i want to pay ${{$data[0]+$data[0]/10}}." class="mt-4 px-6 py-2 bg-white text-black font-semibold rounded-lg hover:bg-gray-500">Payment Via Admin</a>
                </div>
            </div>
